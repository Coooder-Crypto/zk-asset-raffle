...
export function Header() {
  ...
  return (
    <header className="fixed top-0 inset-x-0 z-50 border-b border-slate-200 bg-[#f8f6f2]/90 backdrop-blur">
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between text-slate-900">
        {/* Brand */}
        <Link href="/" className="flex items-center gap-3 group">
          <span className="w-9 h-9 rounded-lg inline-flex items-center justify-center border border-slate-200 bg-white">
