    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      <Card variant="glass" className="text-center">
        <div className="p-5">
          ...
          <div className="mt-2 text-3xl font-bold gradient-text">{activeCount}</div>
      ...
      <Card variant="glass" className="text-center">
        <div className="p-5">
          ...
          <div className="mt-2 text-3xl font-bold gradient-text">{totalTickets}</div>
      ...
      <Card variant="glass" className="text-center">
        <div className="p-5">
          ...
          <div className="mt-2 text-3xl font-bold gradient-text">{completedCount}</div>
